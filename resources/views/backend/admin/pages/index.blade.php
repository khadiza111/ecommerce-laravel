...
{{--Main content to develop--}}
      
                <div class="col-md-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                          <h3 style="color: grey; font-weight: 600; padding-left: 15px;">Welcome to Admin Panel</h3>    
                      </div><br>
                      <p><a href="{{ route('index') }}" class="btn btn-info btn-lg" target="_blank">Visit Main Page</a></p>
                    </div>
                  </div>
                </div>
              

{{--End Main content to develop--}}
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="d-flex mt-3 py-2 border-bottom">
                          <img class="img-sm rounded-circle" src="{{asset('public/images/faces/face3.jpg')}}" alt="profile image">
                        ...
                        <div class="d-flex py-2 border-bottom">
                          <img class="img-sm rounded-circle" src="{{asset('public/images/faces/face4.jpg"')}} alt="profile image">
                          <div class="wrapper ml-2">
