...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('public/css/admin/login.css') }}">
</head>
<body>
...
<script src="{{ asset('public/js/jquery-3.4.1.slim.min.js') }}" integrity="sha384-J6qa4849blE2+poT4WnyKhv5vZF5SrPo0iEjwBvKU7imGFAV0wwj1yYfoRSJoZ+n" crossorigin="anonymous"></script>
